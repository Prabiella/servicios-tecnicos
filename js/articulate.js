...
(function($) {
    ...
    var methods = {
        speak : function(options) {
            ...
            voiceTags["ol"] = new voiceTag("Inicia listado.","Termina listado.");
            voiceTags["ul"] = new voiceTag("Inicia listado.","Termina listado.");
            voiceTags["blockquote"] = new voiceTag("Inicia cita.","Termina cita.");
            voiceTags["img"] = new voiceTag("Hay una imagen con la siguiente descripción:","");
            voiceTags["table"] = new voiceTag("Hay una tabla con el siguiente título:","");
            voiceTags["figure"] = new voiceTag("Hay una figura con el siguiente título:","");
